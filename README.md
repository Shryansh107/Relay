...
[video.webm](https://github.com/user-attachments/assets/795a40f9-cd27-4160-a1fd-cf2d60776051)
...
For a detailed overview of the system design, database schema, and API request/response specifications, refer to the [Architectural Breakdown](architectural.md).
